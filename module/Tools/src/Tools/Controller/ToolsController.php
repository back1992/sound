...
class ToolsController extends AbstractActionController
{
    ...
    public function readdocAction()
    {
        ...
        if ($request->isPost()) {
            ...
            $audioFile = $title;
            echo Dandan::abread_doc_file($audioFile);
            return array('doc' => Dandan::abread_doc_file($audioFile));
        }
        return array('doc' => Dandan::abread_doc_file("./data/cet4/00-10/03/cet4_200306.doc"));
    }
    ...
    public function readquestionAction()
    {
     ...
     if ($request->isPost()) {    
        ...
        $subject = Dandan::abread_doc_file($audioFile);
        // echo $content;
...
echo Dandan::abread_doc_file($doc);
            //  $audioFile = $title;
            // echo Dandan::abread_doc_file($audioFile);
 $mongo = DBConnection::instantiate();
        //get a MongoGridFS instance
